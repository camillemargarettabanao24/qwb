...
class productController extends Controller
{
    public function staff_products(){ 
        ...
        return view('staff-products', compact('products','productImages', 'weddingPackage', 'WeddingProductImages'));
    }
    ...
    public function store(Request $request)
{
    ...
    $request->validate([
       ...
       // Store colors
        ...
        return redirect('staff-products')->with('flash_message', 'Product Added!');
    } catch (\Exception $e) {
        // Log the error
    ...
    public function products_update(Request $request, $id)
    {
        try {
            ...
            return redirect('staff-products')->with('success', 'Product updated successfully!');
        } catch (\Exception $e) {
            // Log the error
            \Log::error('Error in store method: ' . $e->getMessage());
    ...
    public function staff_products_update($id)
    {         
        try {
            ...
            return view('staff-products-update', compact('product', 'colors', 'accessories'));
        } catch (\Exception $e) {
            // Log the error
            \Log::error('Error in staff_products_update method: ' . $e->getMessage());
    ...
    public function staff_products_add()
    {         
        $colors = Color::all(); 
        $accessories = Accessory::all();
        
            return view('staff-products-add', compact( 'colors', 'accessories'));   
    }   
