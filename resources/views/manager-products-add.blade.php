  ...
  <div class="sidebar">
    ...
    <div class="staff-add">
          <div class="staff-add-button">
              <button class="app-content-headerButton"><a href="{{route('manager.manager-products-add-wedding-package')}}">Add Wedding Package</a></button>
          </div>
          ...
          <div class="iphone-staff-add">
                ...
                <form action="{{ route('manager.products.store') }}" class="form" method="POST" enctype="multipart/form-data">
                    @csrf
