                ...
                <div class="parent-staff-app-items">
                    ...
                    <div class="product-cell-button" id="completeButton{{ $reservation->id }}">
                        @if ($reservation->status == 'Reserved')
                            <button style="color: white" class="confirm-button" onclick="confirmRent('{{ route('manager.confirm.rent', ['id' => $reservation->id]) }}', '{{ $reservation->reservation_date }}')">Confirm Rent</button>
                        @elseif ($reservation->status == 'pending')
                            <button style="color: white" onclick="confirmMarkCompleted('{{ route('manager.confirm.reservations', ['id' => $reservation->id]) }}')">Confirm Reservation</button>
                            <button style="background-color: darksalmon; color:white; margin-left:1em" onclick="confirmMarkDeclined('{{ route('manager.decline.reservations', ['id' => $reservation->id]) }}')">Decline Reservation</button>
