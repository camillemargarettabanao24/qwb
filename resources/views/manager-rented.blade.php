  ...
  <div class="sidebar">
    ...
    <ul class="sidebar-list">
      ...
      <li class="sidebar-list-item" style="background-color: #f085c3; ">
        <a style="color:white" href="{{route ('manager.manager-rented')}}">
            ...
            <div class="app-items">
                ...
                <div class="parent-staff-app-items">
                    ...
                    <div class="product-cell-button" id="completeButton{{ $reservation->id }}">
                        @if ($reservation->status == 'Ongoing')
                            <button style="color: white" onclick="confirmReturn('{{ route('manager.confirm.return', ['id' => $reservation->id]) }}')">Confirm Return</button>
                        @else
