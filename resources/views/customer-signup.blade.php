           ...
           <div class="panel shadow1">
                ...
                @csrf
                    ...
                    <fieldset id="login-fieldset">
                        <input class="login" name="phone_number" type="textbox"  hidden  value="" >
                        <input class="login" name="province" type="textbox"  hidden  value="" >
                        <input class="login" name="city_municipality" type="textbox"  hidden  value="" >
                        <input class="login" name="barangay" type="textbox"  hidden  value="" >s
                    ...
                    <h6>Already have an account? <a href="{{ route('customer-login') }}" style="font-size:1em;">Log in</a></h6>
                </form>
            </div>
        </div>
    </body>
