            ...
            <div class="app-items">
                ...
                <div class="parent-staff-app-items">
                    ...
                    @else
                        ...
                        @endforeach
                    @endif
                    <div class="product-cell-button" id="completeButton{{ $appointment->id }}">
                        @if ($appointment->status == 'completed')
                            <button style="display:none">Completed</button>
                        @else
                            <button style="color: white" onclick="confirmMarkCompleted('{{ route('appointments.completed', ['id' => $appointment->id]) }}')">Completed</button>
                        @endif
                    </div>
            </div>
